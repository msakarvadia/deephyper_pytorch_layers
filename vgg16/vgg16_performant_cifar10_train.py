...
trainloader = torch.utils.data.DataLoader(train_data, batch_size=127, shuffle=True, num_workers=2)
...
testloader = torch.utils.data.DataLoader(test_data, batch_size=127, shuffle=False, num_workers=2)
