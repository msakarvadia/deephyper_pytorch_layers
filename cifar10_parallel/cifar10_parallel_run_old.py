   ...
   try:
      ...
      class Net(torch.nn.Module):
         def __init__(self, batch_size,
            ...
            self.conv1 = torch.nn.Conv2d(conv1_in_chan, conv1_out_chan, conv1_kern).to(device, dtype=dtype)
            ...
            self.conv2 = torch.nn.Conv2d(conv1_out_chan,conv2_out_chan,conv2_kern).to(device, dtype=dtype)
